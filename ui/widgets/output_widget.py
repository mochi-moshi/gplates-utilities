...
class OutputWidget(QWidget):
    ...
    def __init__(
        self,
        session: Session,
        file_filter: str = "GPlates Markup Language (*.gpml)",
        enable_topology_generation: bool = True,
        parent=None,
    ):
    ...
    def setup_ui(self):
        ...
        self.append_to_file.setToolTip(
            "If checked, results will be added to existing file instead of overwriting it"
        )
        ...
        if self.enable_topology_generation:
            ...
            self.generate_topologies.setToolTip(
                "Generate topological features for the processed results"
            )
    ...
    def select_output_path(self):
        ...
        file_path, _ = QFileDialog.getSaveFileName(
            self, "Select Output File", initial_path, self.file_filter
        )
